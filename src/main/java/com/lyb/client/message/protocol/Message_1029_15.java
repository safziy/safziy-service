 ...
 * 
 */
public class Message_1029_15 implements IMessage {

	private static int MAIN = 1029;
	private static int SUB = 15;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1029, 15);

	private IDArray iDArray;


	public static Message_1029_15 create() {
		return new Message_1029_15();
	}
