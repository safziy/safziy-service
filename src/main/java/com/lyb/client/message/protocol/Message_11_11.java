 ...
 * 
 */
public class Message_11_11 implements IMessage {

	private static int MAIN = 11;
	private static int SUB = 11;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(11, 11);
	...
	public static Message_11_11 create() {
		return new Message_11_11();
	}
