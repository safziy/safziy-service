 ...
 * 
 */
public class Message_6_17 implements IMessage {

	private static int MAIN = 6;
	private static int SUB = 17;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(6, 17);
	...
	public static Message_6_17 create() {
		return new Message_6_17();
	}
