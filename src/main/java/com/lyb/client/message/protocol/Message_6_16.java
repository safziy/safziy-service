 ...
 * 
 */
public class Message_6_16 implements IMessage {

	private static int MAIN = 6;
	private static int SUB = 16;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(6, 16);
	...
	public static Message_6_16 create() {
		return new Message_6_16();
	}
