 ...
 * 
 */
public class Message_1011_9 implements IMessage {

	private static int MAIN = 1011;
	private static int SUB = 9;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1011, 9);
	...
	public static Message_1011_9 create() {
		return new Message_1011_9();
	}
