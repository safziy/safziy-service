...
public class FriendLogArray implements IMessageEncoder {
	private List<FriendLogArrayItem> list = new LinkedList<FriendLogArrayItem>();

	public List<FriendLogArrayItem> list(){
		return list;
	}
	...
	public void encode(Data data) {
		...
		for (FriendLogArrayItem item : list) {
	...
	public void decode(Data data) {
		...
		for (int i = 0; i < size; i++) {
			FriendLogArrayItem item = FriendLogArrayItem.create();
	...
	public static FriendLogArray create() {
		FriendLogArray array = new FriendLogArray();
		return array;
	}

	public static FriendLogArrayItem createItem() {
		FriendLogArrayItem item = new FriendLogArrayItem();
		return item;
	}

	public FriendLogArrayItem addData(long iD, String paramStr1, String paramStr2, String paramStr3, int time) {
		FriendLogArrayItem item = new FriendLogArrayItem();
		item.setID(iD);
	...
	public void addItem(FriendLogArrayItem item) {
		list.add(item);
	}
	...
	public static class FriendLogArrayItem implements IMessageEncoder {
		private long iD;
		...
		public static FriendLogArrayItem create() {
			FriendLogArrayItem item = new FriendLogArrayItem();
			return item;
		}
