 ...
 * 
 */
public class Message_4_8 implements IMessage {

	private static int MAIN = 4;
	private static int SUB = 8;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(4, 8);
	...
	public static Message_4_8 create() {
		return new Message_4_8();
	}
