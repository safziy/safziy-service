 ...
 * 
 */
public class Message_1007_7 implements IMessage {

	private static int MAIN = 1007;
	private static int SUB = 7;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1007, 7);
	...
	public static Message_1007_7 create() {
		return new Message_1007_7();
	}
