 ...
 * 
 */
public class Message_1007_27 implements IMessage {

	private static int MAIN = 1007;
	private static int SUB = 27;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1007, 27);
	...
	public static Message_1007_27 create() {
		return new Message_1007_27();
	}
