 ...
 * 
 */
public class Message_10_2 implements IMessage {

	private static int MAIN = 10;
	private static int SUB = 2;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(10, 2);
	...
	public static Message_10_2 create() {
		return new Message_10_2();
	}
