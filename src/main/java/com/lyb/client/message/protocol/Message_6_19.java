 ...
 * 
 */
public class Message_6_19 implements IMessage {

	private static int MAIN = 6;
	private static int SUB = 19;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(6, 19);
	...
	public static Message_6_19 create() {
		return new Message_6_19();
	}
