 ...
 * 
 */
public class Message_1008_7 implements IMessage {

	private static int MAIN = 1008;
	private static int SUB = 7;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1008, 7);
	...
	public static Message_1008_7 create() {
		return new Message_1008_7();
	}
