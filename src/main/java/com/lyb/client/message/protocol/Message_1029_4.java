 ...
 * 
 */
public class Message_1029_4 implements IMessage {

	private static int MAIN = 1029;
	private static int SUB = 4;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1029, 4);

	private IDArray iDArray;


	public static Message_1029_4 create() {
		return new Message_1029_4();
	}
