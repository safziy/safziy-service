 ...
 * 
 */
public class Message_1006_12 implements IMessage {

	private static int MAIN = 1006;
	private static int SUB = 12;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1006, 12);
	...
	public static Message_1006_12 create() {
		return new Message_1006_12();
	}
