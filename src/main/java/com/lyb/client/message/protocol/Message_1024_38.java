 ...
 * 
 */
public class Message_1024_38 implements IMessage {

	private static int MAIN = 1024;
	private static int SUB = 38;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1024, 38);

	private IDArray iDArray;


	public static Message_1024_38 create() {
		return new Message_1024_38();
	}
