 ...
 * 
 */
public class Message_7_21 implements IMessage {

	private static int MAIN = 7;
	private static int SUB = 21;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(7, 21);
	...
	public static Message_7_21 create() {
		return new Message_7_21();
	}
