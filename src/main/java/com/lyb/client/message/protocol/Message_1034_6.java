 ...
 * 
 */
public class Message_1034_6 implements IMessage {

	private static int MAIN = 1034;
	private static int SUB = 6;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1034, 6);
	...
	public static Message_1034_6 create() {
		return new Message_1034_6();
	}
