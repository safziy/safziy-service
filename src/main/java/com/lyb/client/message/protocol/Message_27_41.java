 ...
 * 
 */
public class Message_27_41 implements IMessage {

	private static int MAIN = 27;
	private static int SUB = 41;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(27, 41);
	...
	public static Message_27_41 create() {
		return new Message_27_41();
	}
