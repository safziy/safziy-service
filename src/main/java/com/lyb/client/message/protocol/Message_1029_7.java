 ...
 * 
 */
public class Message_1029_7 implements IMessage {

	private static int MAIN = 1029;
	private static int SUB = 7;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1029, 7);
	...
	public static Message_1029_7 create() {
		return new Message_1029_7();
	}
