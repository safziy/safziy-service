 ...
 * 
 */
public class Message_27_13 implements IMessage {

	private static int MAIN = 27;
	private static int SUB = 13;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(27, 13);
	...
	public static Message_27_13 create() {
		return new Message_27_13();
	}
