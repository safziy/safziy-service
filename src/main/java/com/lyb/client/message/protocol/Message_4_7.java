 ...
 * 
 */
public class Message_4_7 implements IMessage {

	private static int MAIN = 4;
	private static int SUB = 7;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(4, 7);
	...
	public static Message_4_7 create() {
		return new Message_4_7();
	}
