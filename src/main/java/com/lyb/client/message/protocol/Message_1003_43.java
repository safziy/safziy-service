 ...
 * 
 */
public class Message_1003_43 implements IMessage {

	private static int MAIN = 1003;
	private static int SUB = 43;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1003, 43);

	private IDArray iDArray;


	public static Message_1003_43 create() {
		return new Message_1003_43();
	}
