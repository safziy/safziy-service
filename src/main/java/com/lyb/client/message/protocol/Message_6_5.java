 ...
 * 
 */
public class Message_6_5 implements IMessage {

	private static int MAIN = 6;
	private static int SUB = 5;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(6, 5);
	...
	public static Message_6_5 create() {
		return new Message_6_5();
	}
