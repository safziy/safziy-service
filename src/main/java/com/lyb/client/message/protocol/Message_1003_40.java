 ...
 * 
 */
public class Message_1003_40 implements IMessage {

	private static int MAIN = 1003;
	private static int SUB = 40;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1003, 40);

	private RedPointArray redPointArray;


	public static Message_1003_40 create() {
		return new Message_1003_40();
	}
