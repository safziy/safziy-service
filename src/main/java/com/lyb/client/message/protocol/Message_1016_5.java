 ...
 * 
 */
public class Message_1016_5 implements IMessage {

	private static int MAIN = 1016;
	private static int SUB = 5;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1016, 5);

	private UserArenaArray userArenaArray;


	public static Message_1016_5 create() {
		return new Message_1016_5();
	}
