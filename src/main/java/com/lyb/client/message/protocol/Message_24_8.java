 ...
 * 
 */
public class Message_24_8 implements IMessage {

	private static int MAIN = 24;
	private static int SUB = 8;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(24, 8);

	private String paramStr1;


	public static Message_24_8 create() {
		return new Message_24_8();
	}
