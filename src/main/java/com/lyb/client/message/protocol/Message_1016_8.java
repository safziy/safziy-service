 ...
 * 
 */
public class Message_1016_8 implements IMessage {

	private static int MAIN = 1016;
	private static int SUB = 8;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(1016, 8);
	...
	public static Message_1016_8 create() {
		return new Message_1016_8();
	}
