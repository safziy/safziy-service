 ...
 * 
 */
public class Message_8_2 implements IMessage {

	private static int MAIN = 8;
	private static int SUB = 2;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(8, 2);
	...
	public static Message_8_2 create() {
		return new Message_8_2();
	}
