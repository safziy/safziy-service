 ...
 * 
 */
public class Message_10_3 implements IMessage {

	private static int MAIN = 10;
	private static int SUB = 3;
	private static String MESSAGE_KEY = DummyUtils.getCompositeKey(10, 3);
	...
	public static Message_10_3 create() {
		return new Message_10_3();
	}
