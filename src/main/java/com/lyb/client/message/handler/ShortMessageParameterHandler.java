...
public class ShortMessageParameterHandler extends AbstractMessageParameterHandler {

	private int min;
	private int max;

	public ShortMessageParameterHandler(String name,String type, String param) {
